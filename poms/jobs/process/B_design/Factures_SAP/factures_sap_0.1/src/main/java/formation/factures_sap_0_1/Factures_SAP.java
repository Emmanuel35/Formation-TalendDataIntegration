...
package formation.factures_sap_0_1;
 ...
 * @status
 */
public class Factures_SAP implements TalendJob {
	...
	private final String jobName = "Factures_SAP";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Factures_SAP.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				formation.t1_0_1.T1 childJob_tRunJob_6 = new formation.t1_0_1.T1();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				formation.t1_0_1.T1 childJob_tRunJob_5 = new formation.t1_0_1.T1();
				// pass DataSources
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_FORMATION_Factures_SAP = new byte[0];
		static byte[] commonByteArray_FORMATION_Factures_SAP = new byte[0];

		public void readData(ObjectInputStream dis) {

			synchronized (commonByteArrayLock_FORMATION_Factures_SAP) {
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				formation.a1_0_1.A1 childJob_tRunJob_1 = new formation.a1_0_1.A1();
				// pass DataSources
				...
				for (String[] item_tRunJob_1 : childReturn_tRunJob_1) {
					...
					formation.b1_0_1.B1 childJob_tRunJob_2 = new formation.b1_0_1.B1();
					// pass DataSources
					...
					formation.b2_0_1.B2 childJob_tRunJob_3 = new formation.b2_0_1.B2();
					// pass DataSources
					...
					formation.b3_0_1.B3 childJob_tRunJob_4 = new formation.b3_0_1.B3();
					// pass DataSources
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tRunJob_1:OnSubjobOk1", "",
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tRunJob_1:OnSubjobOk2", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
	...
	public void tRunJob_7Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				formation.t1_0_1.T1 childJob_tRunJob_7 = new formation.t1_0_1.T1();
				// pass DataSources
	...
	public void tRunJob_8Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				formation.t1_0_1.T1 childJob_tRunJob_8 = new formation.t1_0_1.T1();
				// pass DataSources
	...
	public static void main(String[] args) {
		final Factures_SAP Factures_SAPClass = new Factures_SAP();

		int exitCode = Factures_SAPClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Factures_SAP.class.getClassLoader()
					.getResourceAsStream("formation/factures_sap_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Factures_SAP.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Factures_SAP");
		}
...
/************************************************************************************************
 * 87804 characters generated by Talend Open Studio for Data Integration on the
 * 1 juin 2020 18:45:51 CEST
 ************************************************************************************************/
...
package formation.managexmlfile_0_1;
 ...
 * @status
 */
public class ManageXMLFile implements TalendJob {
	...
	private final String jobName = "ManageXMLFile";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					ManageXMLFile.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ManageXMLFile.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class outStruct implements routines.system.IPersistableRow<outStruct> {
		final static byte[] commonByteArrayLock_FORMATION_ManageXMLFile = new byte[0];
		static byte[] commonByteArray_FORMATION_ManageXMLFile = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FORMATION_ManageXMLFile) {
...
// build root xml tree 
						...
						loop = org.dom4j.DocumentHelper.createElement("Email");
						subTreeRootParent.elements().add(orderHelper.getInsertLocation(0, 0), loop);
						subTreeRootParent = loop;
						valueMap.put("loop", treeNodeAPI.get_String("row1.content:/Customers/Customer/Contact/email"));
						if (valueMap.get("loop") != null) {
							routines.system.NestXMLTool.setText(loop, FormatterUtils.fm(valueMap.get("loop"), null));
						}
					}
				}
				...
				try {
					filename_tFileInputXML_1 = "G:/Mon Drive/Formations/202004 Talend OpenSource Data Integration/Les composants de base/Customers.xml";
				...
				if (isValidFile_tFileInputXML_1) {
					...
					org.dom4j.XPath x_tFileInputXML_1 = doc_tFileInputXML_1
							.createXPath(nsTool_tFileInputXML_1.addDefaultNSPrefix("/"));
...
//init all mapping xpaths
					...
					for (org.dom4j.Node temp_tFileInputXML_1 : nodeList_tFileInputXML_1) {
						...
						try {
							...
							row1.content = ParserUtils.parseTo_Document(str_tFileInputXML_1, false, "ISO-8859-15");
...
// Start of branch "row1"
						if (row1 != null) {
							...
							docToFlat_tXMLMap_1_TXMLMAP_OUT.setOriginalLoop("/Customers/Customer");
							...
							org.dom4j.Document doc_tXMLMap_1_TXMLMAP_OUT = row1.content.getDocument();
							...
							absolutePathMappings_tXMLMap_1_TXMLMAP_OUT[0] = "row1.content:/Customers/Customer/Contact/email";
							relativePathMappings_tXMLMap_1_TXMLMAP_OUT[0] = "Contact/email";
...
//init one new out struct for cache the result.
										...
										out_aggregate.content = new routines.system.Document();
										out_aggregate.content
												.setDocument(gen_Doc_out_tXMLMap_1_TXMLMAP_OUT.getDocument());
...
// ###############################
				...
				String originalFileName_tFileOutputXML_1 = "D:/TEMP/outXML.xml";
				...
				for (Object row_out_tXMLMap_1_TXMLMAP_IN : outs_tXMLMap_1) {// TD512
					...
					if (row_out_tXMLMap_1_TXMLMAP_IN != null && row_out_tXMLMap_1_TXMLMAP_IN instanceof outStruct) {
						...
						routines.system.NestXMLTool.generateOk(out.content, false);
					}
...
// Start of branch "out"
					if (out != null) {
						...
						writer_tFileOutputXML_1.write(out.content.getDocument());
	...
	public static void main(String[] args) {
		final ManageXMLFile ManageXMLFileClass = new ManageXMLFile();

		int exitCode = ManageXMLFileClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ManageXMLFile.class.getClassLoader()
					.getResourceAsStream("formation/managexmlfile_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = ManageXMLFile.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ManageXMLFile");
		}
...
/************************************************************************************************
 * 54532 characters generated by Talend Open Studio for Data Integration on the
 * 24 mai 2020 17:16:49 CEST
 ************************************************************************************************/
...
package formation.listrnafilesandlaunch_0_1;
...
/**
 * Job: ListRNAFilesAndLaunch Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class ListRNAFilesAndLaunch implements TalendJob {
	...
	private final String jobName = "ListRNAFilesAndLaunch";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					ListRNAFilesAndLaunch.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ListRNAFilesAndLaunch.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tSetGlobalVar_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				globalMap.put("BASE_PATH",
						"D:/TEMP/" + TalendDate.formatDate("yyyyMMdd_HHmmss", TalendDate.getCurrentDate()) + "/");
	...
	public void tFileUnarchive_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String zipFileURL_tFileUnarchive_1 = "D:/Users/emman/Downloads/rna_import_20200501.zip";
				String tmpFileURL_tFileUnarchive_1 = zipFileURL_tFileUnarchive_1.toLowerCase();
				String outputPath_tFileUnarchive_1 = ((String) globalMap.get("BASE_PATH"));
				...
				if (tmpFileURL_tFileUnarchive_1.endsWith(".tar.gz") || tmpFileURL_tFileUnarchive_1.endsWith(".tgz")) {
					...
					final String decryptedPassword_tFileUnarchive_1 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:XwynMrLqxj1CRSIwIeFkVMiJ2k561H53c3fJhA==");
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tFileUnarchive_1:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
	...
	public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String directory_tFileList_1 = ((String) globalMap.get("BASE_PATH"));
				...
				for (int i_tFileList_1 = 0; i_tFileList_1 < list_tFileList_1.size(); i_tFileList_1++) {
					...
					if (obj_tRunJob_1 != null) {
						paraList_tRunJob_1
								.add("--context_param FILE_IN=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
					} else {
						paraList_tRunJob_1.add("--context_param FILE_IN="
								+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
					}

					parentContextMap_tRunJob_1.put("FILE_IN", obj_tRunJob_1);

					obj_tRunJob_1 = ((String) globalMap.get("tFileList_1_CURRENT_FILEDIRECTORY")) + "/";
					if (obj_tRunJob_1 != null) {
						paraList_tRunJob_1
								.add("--context_param DIR_IN=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
					} else {
						paraList_tRunJob_1.add(
								"--context_param DIR_IN=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
					}

					parentContextMap_tRunJob_1.put("DIR_IN", obj_tRunJob_1);

					obj_tRunJob_1 = ((String) globalMap.get("tFileList_1_CURRENT_FILE")) + ".json";
					if (obj_tRunJob_1 != null) {
						paraList_tRunJob_1
								.add("--context_param FILE_OUT=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
					} else {
						paraList_tRunJob_1.add("--context_param FILE_OUT="
								+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
					}

					parentContextMap_tRunJob_1.put("FILE_OUT", obj_tRunJob_1);

					obj_tRunJob_1 = ((String) globalMap.get("tFileList_1_CURRENT_FILEDIRECTORY")) + "/JSON/";
					if (obj_tRunJob_1 != null) {
						paraList_tRunJob_1
								.add("--context_param DIR_OUT=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
					} else {
						paraList_tRunJob_1.add("--context_param DIR_OUT="
								+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
					}

					parentContextMap_tRunJob_1.put("DIR_OUT", obj_tRunJob_1);

					formation.loadfilearn_0_1.LoadFileARN childJob_tRunJob_1 = new formation.loadfilearn_0_1.LoadFileARN();
					// pass DataSources
	...
	public static void main(String[] args) {
		final ListRNAFilesAndLaunch ListRNAFilesAndLaunchClass = new ListRNAFilesAndLaunch();

		int exitCode = ListRNAFilesAndLaunchClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ListRNAFilesAndLaunch.class.getClassLoader()
					.getResourceAsStream("formation/listrnafilesandlaunch_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = ListRNAFilesAndLaunch.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : ListRNAFilesAndLaunch");
		}
...
/************************************************************************************************
 * 50423 characters generated by Talend Open Studio for Data Integration on the
 * 28 mai 2020 18:50:02 CEST
 ************************************************************************************************/
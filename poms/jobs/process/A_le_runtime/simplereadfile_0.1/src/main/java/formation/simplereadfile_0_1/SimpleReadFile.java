...
package formation.simplereadfile_0_1;
...
/**
 * Job: SimpleReadFile Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class SimpleReadFile implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "SimpleReadFile";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				SimpleReadFile.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SimpleReadFile.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
class Comparablerow1Struct extends row1Struct implements Comparable<Comparablerow1Struct> {
	...
	public int compareTo(Comparablerow1Struct other) {
		...
		if(this.Jour == null && other.Jour != null){
			return -1;
						
		}else if(this.Jour != null && other.Jour == null){
			return 1;
						
		}else if(this.Jour != null && other.Jour != null){
			if(!this.Jour.equals(other.Jour)){
				return this.Jour.compareTo(other.Jour);
			}
		}
		return 0;
	}
					...
					columnIndexWithD_tFileInputDelimited_1 = 0;
						...
						if(temp.length() > 0) {
								...
								try {
    									...
    									row1.Jour = ParserUtils.parseTo_Date(temp, "dd/MM/yyyy");
...
if(row1 != null) { 
	...
	arrayRowtSortRow_1_SortOut.Jour = row1.Jour;
	arrayRowtSortRow_1_SortOut.Produit = row1.Produit;	
 ...
 */
	...
	currentComponent="tFileOutputExcel_1";
		...
		String fileName_tFileOutputExcel_1="C:/TEMP/out.xls";
		...
		xlsxTool_tFileOutputExcel_1.addCellValue("Jour");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("Produit");
...
for(int i_tSortRow_1_SortIn = 0; i_tSortRow_1_SortIn < array_tSortRow_1_SortIn.length; i_tSortRow_1_SortIn++){
	...
	row2.Jour = current_tSortRow_1_SortIn.Jour;
	row2.Produit = current_tSortRow_1_SortIn.Produit;
	...
	currentComponent="tFileOutputExcel_1";
				...
				xlsxTool_tFileOutputExcel_1.addRow();
	    				...
	    				if(row2.Jour != null) {
							...
							xlsxTool_tFileOutputExcel_1.addCellValue(row2.Jour, "dd/MM/yyyy");
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row2.Produit != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row2.Produit));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
 ...
 */
    ...
    public static void main(String[] args){
        final SimpleReadFile SimpleReadFileClass = new SimpleReadFile();

        int exitCode = SimpleReadFileClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SimpleReadFile.class.getClassLoader().getResourceAsStream("formation/simplereadfile_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SimpleReadFile.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SimpleReadFile");
        }
